...
bool LightingTechnique::Init()
{
    ...
    if (!AddShader(GL_VERTEX_SHADER, "C:/Users/Amir/Desktop/For UGATU/Computer graphics/shaders/shaders43/lighting.vs")) {
        return false;
    }

    if (!AddShader(GL_FRAGMENT_SHADER, "C:/Users/Amir/Desktop/For UGATU/Computer graphics/shaders/shaders43/lighting.fs")) {
        return false;
    }
